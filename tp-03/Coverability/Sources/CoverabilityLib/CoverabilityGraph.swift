...
public class CoverabilityGraph<Place> where Place: CaseIterable & Hashable{
  
  public typealias CoverabilityMarking = [Place: Token]
  
  public init(
    marking: CoverabilityMarking, successors: [PTTransition<Place>: CoverabilityGraph] = [:])
  {
  ...
  public var successors: [PTTransition<Place>: CoverabilityGraph]
